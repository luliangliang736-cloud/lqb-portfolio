...
const rawShowcases: ShowcaseItem[] = [
  {
    ...
    cta: '查看作品',
    accent: 'primary',
    coverSrc: '/assets/showcases/creative-visuals/cover.webp',
  },
  {
    id: 'form-design',
    slug: 'form-design',
    ...
    cta: '查看作品',
    accent: 'violet',
    coverSrc: '/assets/showcases/form-design/cover.webp',
  },
  {
    id: 'ip-scenario',
    slug: 'ip-scenario',
    ...
    cta: '查看作品',
    accent: 'emerald',
    coverSrc: '/assets/showcases/ip-scenario/cover.webp',
  },
  {
    ...
    cta: '查看作品',
    accent: 'sky',
    coverSrc: '/assets/home-work-track.webp',
  },
  {
    id: 'dynamic-vision',
    slug: 'dynamic-vision',
    ...
    cta: '查看作品',
    accent: 'amber',
    coverSrc: '/assets/showcases/dynamic-vision/cover.webp',
  },
  {
    id: 'beyond-design',
    slug: 'beyond-design',
    ...
    cta: '查看作品',
    accent: 'rose',
    coverSrc: '/assets/home-beyond-design.webp',
  },
];
...
const creativeVisualsMedia: ShowcaseMediaItem[] = [
  {
    ...
    src: '/assets/showcases/creative-visuals/01.webp',
    detailMedia: [
      '/assets/showcases/creative-visuals/discount-poster/KV - 绿人.png',
      '/assets/showcases/creative-visuals/discount-poster/KV-后期1.webp',
      ...
      '/assets/showcases/creative-visuals/discount-poster/整合-白色底-01.webp',
      '/assets/showcases/creative-visuals/discount-poster/整合-白色底-02.webp',
      '/assets/showcases/creative-visuals/discount-poster/整合-白色底-03.webp',
      '/assets/showcases/creative-visuals/discount-poster/整合-白色底-05.webp',
  ...
  },
  {
    ...
    src: '/assets/showcases/creative-visuals/02.webp',
  },
  {
    id: 'character-series',
    ...
    src: '/assets/showcases/creative-visuals/03.webp',
  },
  {
    id: 'yearbook-layout',
    ...
    src: '/assets/showcases/creative-visuals/06.webp',
  },
  {
    id: 'graphic-poster',
    ...
    src: '/assets/showcases/creative-visuals/07.webp',
  },
];
...
const formDesignMedia: ShowcaseMediaItem[] = [
  {
    ...
    src: '/assets/showcases/form-design/02.webp',
    detailMedia: [
      '/assets/showcases/form-design/music-theme-packaging/01.webp',
      '/assets/showcases/form-design/music-theme-packaging/02.webp',
      '/assets/showcases/form-design/music-theme-packaging/03.webp',
      '/assets/showcases/form-design/music-theme-packaging/04.webp',
      '/assets/showcases/form-design/music-theme-packaging/05.webp',
      '/assets/showcases/form-design/music-theme-packaging/06.webp',
      '/assets/showcases/form-design/music-theme-packaging/07.webp',
      '/assets/showcases/form-design/music-theme-packaging/08.webp',
      '/assets/showcases/form-design/music-theme-packaging/10.webp',
  ...
  },
  {
    ...
    src: '/assets/showcases/form-design/盒子心.webp',
    detailMedia:[
...
const ipScenarioMedia: ShowcaseMediaItem[] = [
  ...
  },
  {
    ...
    src: '/assets/showcases/ip-scenario/03.webp',
  },
  {
    ...
    src: '/assets/showcases/ip-scenario/04.webp',
  },
  {
    ...
    src: '/assets/showcases/ip-scenario/05.webp',
  },
  {
...
const waterfallCollectionMedia: ShowcaseMediaItem[] = [
  {
    title: 'Green - Lu78',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-02.webp',
  },
  {
    title: 'KV - Green Figure',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-03.webp',
  },
  {
    title: 'KV - Postproduction 1',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-04.webp',
  },
  {
  ...
  },
  {
    title: 'tt',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-07.webp',
  },
  {
    title: 'Simplifying Traditional Chinese - Lu78',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-08.webp',
  },
  {
    title: 'Overseas Website Visual - Handcrafted Edition',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-09.webp',
  },
  {
    title: 'Long Time No See - Lu78 06-20',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-10.webp',
  },
  {
    title: 'Red Packet Cover 2 - Artboard 1 Copy',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-11.webp',
  },
  {
    title: 'Fragments of Notes - Lu78',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-12.webp',
  },
  {
    title: 'Creative Brand Output - Artboard 1 Copy',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-13.webp',
  },
  {
    title: 'Ten Outfits with Nano in Three Minutes - Lu78',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-14.webp',
  },
  {
    title: 'Wuyou IP Character - Pomelo Version',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-15.webp',
  },
  {
    title: 'Wuyou Night + Typography Design 2',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-16.webp',
  },
  {
    title: 'Summer Sticker Series 01',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-17.webp',
  },
  {
    title: 'Xiaohongshu - Artboard 1',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-18.webp',
  },
  {
    title: 'Xiaohongshu Green - Artboard 1 Copy 3',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-19.webp',
  },
  {
    title: 'Xiaohongshu Green - Artboard 1 Copy',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-20.webp',
  },
  {
    title: 'Xiaohongshu Green - Artboard 1',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-21.webp',
  },
  {
    title: 'Indonesian Local Life - Three UI Versions',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-22.webp',
  },
  {
    title: 'Rebuilding Creativity with AI - Lu78',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-23.webp',
  },
  {
    title: 'Operational Visuals - Lu78',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-24.webp',
  },
  {
    title: 'White Base Composite 01',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-25.webp',
  },
  {
    title: 'White Base Composite 02',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-26.webp',
  },
  {
    title: 'White Base Composite 03',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-27.webp',
  },
  {
    title: 'White Base Composite 05',
    description: '',
    src: '/assets/showcases/waterfallCollectionMedia/waterfallCollectionMedia/archive-28.webp',
  },
];
