...
export const heroMediaDesktop = ([
  { src: '/assets/hero-media/hero-banner.mp4', type: 'video' },
  { src: '/assets/hero-media/frame-78.jpg', type: 'image', alt: '首页轮播 Frame 78' },
  { src: '/assets/hero-media/4月12日(1)-1.mp4', type: 'video' },
] satisfies HeroMediaItem[]).map(withAssetPath);

// 移动端只加载精简视频，减少首屏等待。
export const heroMediaMobile = ([
  { src: '/assets/hero-media/mobile-hero-1.mp4', type: 'video' },
  { src: '/assets/hero-media/mobile-hero-2.mp4', type: 'video' },
] satisfies HeroMediaItem[]).map(withAssetPath);
